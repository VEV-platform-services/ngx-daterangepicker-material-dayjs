...
import { InjectionToken, Injectable, Inject, EventEmitter, forwardRef, Component, ViewEncapsulation, Input, Output, ViewChild, Directive, HostBinding, HostListener, NgModule } from '@angular/core';
...
class DaterangepickerComponent {
    ...
    daterangepicker = { start: new UntypedFormControl(), end: new UntypedFormControl() };
    ...
    firstMonthDayClass = null;
    lastMonthDayClass = null;
    emptyWeekRowClass = null;
    emptyWeekColumnClass = null;
    firstDayOfNextMonthClass = null;
    lastDayOfPreviousMonthClass = null;
    _locale = {};
    set locale(value) {
    ...
    nowHoveredDate = null;
    pickingDate = false;
    options = {}; // should get some opt from user
    drops;
    opens;
    ...
    _getDateWithTime(date, side) {
        if (!this.timepickerVariables[side]?.selectedHour)
            return date;
        let hour = parseInt(this.timepickerVariables[side].selectedHour, 10);
        if (!this.timePicker24Hour) {
            const ampm = this.timepickerVariables[side].ampmModel;
...
class DaterangepickerDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: DaterangepickerDirective, deps: [{ token: i0.ViewContainerRef }, { token: i0.ChangeDetectorRef }, { token: i0.ComponentFactoryResolver }, { token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i0.KeyValueDiffers }, { token: LocaleService }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: DaterangepickerDirective, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ViewContainerRef }, { type: i0.ChangeDetectorRef }, { type: i0.ComponentFactoryResolver }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i0.KeyValueDiffers }, { type: LocaleService }, { type: i0.ElementRef }]; }, propDecorators: { minDate: [{
                type: Input
            }], maxDate: [{
                type: Input
            }], autoApply: [{
...
//# sourceMappingURL=ngx-daterangepicker-material-dayjs.mjs.map
